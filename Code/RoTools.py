...
def Credits():
    ...
    print(F"{Fore.CYAN}║ Version: 0.1.0-prealpha                                 ║")
    print(F"{Fore.CYAN}║                                                         ║")
    print(F"{Fore.CYAN}║ Changelog:                                              ║")
    print(F"{Fore.CYAN}║ - Added Main Menu                                       ║")
    print(F"{Fore.CYAN}║ - Added Credits                                         ║")
    print(F"{Fore.CYAN}║ - Added Discord Menu                                    ║")
    print(F"{Fore.CYAN}║ - Added Nitro Codes Generator                           ║")
    print(F"{Fore.CYAN}║ - Added Token Generator                                 ║")
    print(F"{Fore.CYAN}║ - Added Webhook Spammer                                 ║")
    print(F"{Fore.CYAN}║ - Added Webhook Deleter                                 ║")
    print(F"{Fore.CYAN}╚═════════════════════════════════════════════════════════╝")
...
def DiscordMenu():
    ...
    print(f"{Fore.CYAN}║ 4 - Webhook Deleter                                     ║")
