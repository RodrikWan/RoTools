...
def Credits():
    os.system(f'title RoTools 0.4 | Credits')
    os.system('cls')
...
def DiscordMenu():
    os.system(f'title RoTools 0.4 | Discord Menu')
    os.system('cls')
...
def NitroGenerator():
    os.system(f'title RoTools 0.4 | Discord Nitro Generator')
    os.system('cls')
...
def TokenGenerator():
    os.system(f'title RoTools 0.4 | Discord Token Generator')
    os.system('cls')
    print(F"{Fore.CYAN}╔═════════════════════════════════════════════════════════╗")#-------------------|
    print(F"{Fore.CYAN}║{Fore.WHITE}██████╗  █████╗ ████████╗ █████╗  █████╗ ██╗      ██████╗{Fore.CYAN}║")
    print(F"{Fore.CYAN}║{Fore.WHITE}██╔══██╗██╔══██╗╚══██╔══╝██╔══██╗██╔══██╗██║     ██╔════╝{Fore.CYAN}║")
...
def TokenInfo():
    os.system(f'title RoTools 0.4 | Discord Token Info')
    os.system('cls')
...
def TokenFromEmailPass():
    os.system(f'title RoTools 0.4 | Discord Token from Email/Password')
    os.system('cls')
...
def WebhookSpammer():
    os.system(f'title RoTools 0.4 | Discord Webhook Spammer')
    os.system('cls')
...
def WebhookDeleter():
    os.system(f'title RoTools 0.4 | Discord Webhook Deleter')
    os.system('cls')
...
def HalfToken():
    os.system(f'title RoTools 0.4 | Discord Half Token from user ID')
    os.system('cls')
...
def MainMenu():
    os.system(f'title RoTools 0.4 | Main Menu')
    os.system('cls')
