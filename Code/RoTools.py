...
def Credits():
    os.system('title RoTools 0.5 - Credits')
    os.system('cls')
    ...
    print(F"{Fore.CYAN}║{Fore.WHITE} Version: 0.5.0-prealpha                                 {Fore.CYAN}║")
    print(F"{Fore.CYAN}║                                                         ║")#-------------------|
    print(F"{Fore.CYAN}║{Fore.WHITE} Changelog:                                              {Fore.CYAN}║")
    print(F"{Fore.CYAN}║{Fore.WHITE} - Added change Hypesquad House                          {Fore.CYAN}║")
    print(F"{Fore.CYAN}║{Fore.WHITE} - Critical bug fix                                      {Fore.CYAN}║")
    print(F"{Fore.CYAN}╚═════════════════════════════════════════════════════════╝")#-------------------|
...
def DiscordMenu():
    os.system('title RoTools 0.5 - Discord Menu')
    os.system('cls')
...
def NitroGenerator():
    os.system('title RoTools 0.5 - Discord Nitro Generator')
    os.system('cls')
...
def TokenGenerator():
    os.system('title RoTools 0.5 - Discord Token Generator')
    os.system('cls')
    print(F"{Fore.CYAN}╔═════════════════════════════════════════════════════════╗")#-------------------|
    print(F"{Fore.CYAN}║{Fore.WHITE}██████╗  █████╗ ████████╗ █████╗  █████╗ ██╗      ██████╗{Fore.CYAN}║")
    print(F"{Fore.CYAN}║{Fore.WHITE}██╔══██╗██╔══██╗╚══██╔══╝██╔══██╗██╔══██╗██║     ██╔════╝{Fore.CYAN}║")
...
def TokenInfo():
    os.system('title RoTools 0.5 - Discord Token Info')
    os.system('cls')
...
def TokenFromEmailPass():
    os.system('title RoTools 0.5 - Discord Token from Email/Password')
    os.system('cls')
...
def WebhookSpammer():
    os.system('title RoTools 0.5 - Discord Webhook Spammer')
    os.system('cls')
...
def WebhookDeleter():
    os.system('title RoTools 0.5 - Discord Webhook Deleter')
    os.system('cls')
...
def HalfToken():
    os.system('title RoTools 0.5 - Discord Half Token from user ID')
    os.system('cls')
...
def ChangeHypesquadHouse():
    os.system('title RoTools 0.5 - Discord change Hypesquad House')
    os.system('cls')
    ...
    try:
        ...
        ChangeHypesquadHouseToken = input(f'{Fore.WHITE}Token: ')
...
def MainMenu():
    os.system('title RoTools 0.5 - Main Menu')
    os.system('cls')
